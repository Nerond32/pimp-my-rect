...
describe('gallery', () => {
  ...
  it('renders correct amount of rectangles', () => {
    ...
    expect(gallery3.find('.c-gallery-container__item')).toHaveLength(3);
    expect(gallery7.find('.c-gallery-container__item')).toHaveLength(7);
  });
  it('renders correctly with empty array of rectangles', () => {
    const gallery0 = shallow(<GalleryContainer rects={[]} {...props} />);
    expect(gallery0.find('.c-gallery-container__item')).toHaveLength(0);
  });
  it('renders with filtered out rectangles', () => {
    ...
    expect(galleryFiltered3.find('.c-gallery-container__item')).toHaveLength(2);
    expect(galleryFiltered7.find('.c-gallery-container__item')).toHaveLength(4);
  });
});
